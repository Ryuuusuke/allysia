...
function SmallPhoneView() {
	return (
		<div className="bg-black overflow-x-hidden">
			<header className="bg-black text-white flex items-center ml-[-1rem] justify-center mt-12">
				<p className="text-2xl font-semibold">Welcome to Allysia!</p>
			</header>
			<div className="flex h-screen mt-[-5rem] ml-7 bg-black flex-col items-center justify-center text-white w-screen">
					...
					<div className="overflow-visible">
						<div className="relative w-fit h-fit">
							<Umbrella
								...
								size={121}
								strokeWidth={0.7}
								className="absolute  -top-[35%] right-[-65%] -rotate-[-21deg]  hover:animate-spin"
							/>
							<img
								src="/pandoraside.jpg"
								alt="Pandora Image"
				...
				<footer className="absolute bottom-17 left-0 right-0">
