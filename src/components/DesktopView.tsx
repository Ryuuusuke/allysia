...
function DesktopView() {
	return (
		<div className="bg-black overflow-x-hidden">
			...
			<div className="flex h-screen mt-[-9rem] bg-black flex-col items-center justify-center text-white w-screen">
					...
					<div className="overflow-visible">
						<div className="relative w-fit h-fit">
							<Umbrella
								...
								size={211}
								strokeWidth={0.7}
								className="absolute -top-[63%] left-[-106%] rotate-[-18deg] hover:animate-spin"
							/>
							<img
								src="/pandoraside.jpg"
								alt="Pandora Image"
